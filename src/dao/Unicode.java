...
public class Unicode {
	public static String pat=   
           ...
           /* "[\u2E80-\u2EFF]|"+//：CJK 部首补充 (CJK Radicals Supplement)  中文*/
            "[\u2F00-\u2FDF]|"+//：康熙字典部首 (Kangxi Radicals)  中文
            "[\u2FF0-\u2FFF]|"+//：表意文字描述符 (Ideographic Description Characters)  中文
            "[\u3000-\u303F]|"+//：CJK 符号和标点 (CJK Symbols and Punctuation)  中文
            "[\u3040-\u309F]|"+//：日文平假名 (Hiragana)  
            "[\u30A0-\u30FF]|"+//：日文片假名 (Katakana)  
           /* "[\u3100-\u312F]|"+//：注音字母 (Bopomofo)  中文*/
            "[\u3130-\u318F]|"+//：朝鲜文兼容字母 (Hangul Compatibility Jamo)  
            "[\u3190-\u319F]|"+//：象形字注释标志 (Kanbun)  
            /*"[\u31A0-\u31BF]|"+//：注音字母扩展 (Bopomofo Extended)  中文
            "[\u31C0-\u31EF]|"+//：CJK 笔画 (CJK Strokes)  中文*/
            "[\u31F0-\u31FF]|"+//：日文片假名语音扩展 (Katakana Phonetic Extensions)  
            "[\u3200-\u32FF]|"+//：封闭式 CJK 文字和月份 (Enclosed CJK Letters and Months)  
            /*"[\u3300-\u33FF]|"+//：CJK 兼容 (CJK Compatibility)  */
            "[\u3400-\u4DBF]|"+//：CJK 统一表意符号扩展 A (CJK Unified Ideographs Extension A)  中文
            "[\u4DC0-\u4DFF]|"+//：易经六十四卦符号 (Yijing Hexagrams Symbols)  
            /*"[\u4E00-\u9FBF]|"+//：CJK 统一表意符号 (CJK Unified Ideographs)常用汉字区域，该区域常用于【正则表达式】  中文*/
            "[\uA000-\uA48F]|"+//：彝文音节 (Yi Syllables)  
            "[\uA490-\uA4CF]|"+//：彝文字根 (Yi Radicals)  
            "[\uA500-\uA61F]|"+//：Vai  
          ...
          /*  //"\uD800-\uDBFF"+//：High-half zone of UTF-16  
            ...
            "[\uE000-\uF8FF]|"+//：自行使用区域 (Private Use Zone)  有中文
            "[\uF900-\uFAFF]|"+//：CJK 兼容象形文字 (CJK Compatibility Ideographs)  中文*/
